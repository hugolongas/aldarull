                ...
                <div class="col-sm-12 col-md-4">
                    <div class="contractacio">
                        <div class="info-contractacio">
                            ...
                            <div class="info">
                                Teléfon: <span>{!!Resources::GetResource('footer.telefon')!!}</span><br/>
                                E-mail: <span>{!!Resources::GetResource('footer.email')!!}</span>
                            </div>
                        </div>
                        <div class="xarxes-socials">
                            <h4>Xarxes Socials</h4>
                            <div class="social">
                                <a href="https://www.facebook.com/Aldarull-Grup-1238683506180613" alt="facebook-aldarull">
                                <img src="{{ asset('img/facebook.png') }}" class="img-fluid"/>
                            </a>
                            </div>
                            <div class="social">
                                <a href="https://www.instagram.com/aldarull_grup/" alt="instagram-aldarull">
                                    <img src="{{ asset('img/instagram.png') }}" class="img-fluid" />
                                </a>
                            </div>
                            <div class="social">
                                <a href="https://www.youtube.com/channel/UCJynQj7HktHfa5UpvmZ8e-g" alt="youtube-aldarull">
                                    <img src="{{ asset('img/youtube.png') }}"  class="img-fluid"/>
                                </a>
                            </div>
                        </div>
                    </div>
